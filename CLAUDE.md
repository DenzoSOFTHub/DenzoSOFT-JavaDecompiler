...
`DecompilerTest.main()` — there is no test selector. Current baseline: **44/45**; `BasicClass` fails
...
2. Run `DecompilerTest` with the JDK 25 javac path (44/45 — only the known `BasicClass` expectation may fail)
