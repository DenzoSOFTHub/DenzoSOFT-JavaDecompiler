...
mvn clean package          # Build JAR (target/java-decompiler-1.6.0.jar)
mvn test                   # Run tests (if surefire configured)
```

**Running the decompiler:**
```bash
java -jar target/java-decompiler-1.6.0.jar                                   # GUI (default)
java -jar target/java-decompiler-1.6.0.jar <file.class>                      # CLI, line-aligned
java -jar target/java-decompiler-1.6.0.jar --compact <file.class>            # Compact output
java -jar target/java-decompiler-1.6.0.jar --show-bytecode <file.class>      # Inline bytecode instructions
java -jar target/java-decompiler-1.6.0.jar --show-native-info <file.class>   # JNI info on native methods
java -jar target/java-decompiler-1.6.0.jar --deobfuscate <file.class>        # Sanitize obfuscated names
java -jar target/java-decompiler-1.6.0.jar <file.jar> <ClassName>            # From JAR
java -jar target/java-decompiler-1.6.0.jar --batch <file.jar> <output-dir>   # Batch
java -jar target/java-decompiler-1.6.0.jar --gui [file.jar ...]              # GUI explicit
java -jar target/java-decompiler-1.6.0.jar --trace <dir> <file>              # Tracing
```
